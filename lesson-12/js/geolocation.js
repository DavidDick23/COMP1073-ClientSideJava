...
{
    // Display a message
    statusMsg.textContent = "We found your location...";
...
function error()
{
    statusMsg.textContent = "Sorry we cannot get your location";
}
...
if(!navigator.geolocation)
{
    ...
    statusMsg.textContent = "Sorry geolocation not supported by your device";
}
else
{
